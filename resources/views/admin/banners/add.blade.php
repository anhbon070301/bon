                            ...
                            <form action="{{ route('storeBanners') }}" method="post" id="edit-profile" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="firstname">Title @if ( $errors ->has('title') ) <span>*</span>@else <span>*</span> @endif</label>
                                        <div class="controls">
                                            <input type="text" class="span3" name="title" id="firstname" value="{!! old('title') !!}">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" id="image" name="image_url" type="file" value="{!! old('image_url') !!}" title="No Image"/>
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->

                                    <div class="control-group">
                                        <label class="control-label" for="firstname">Content @if ( $errors ->has('content') ) <span>*</span>@else <span>*</span> @endif</label>
                                        <div class="controls">
