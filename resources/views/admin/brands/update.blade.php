                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            @else 
                                                <input type="text" class="span3" name="sort_order" value="{{ $brand->sort_order }}">
                                            @endif   
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="hidden" name="image_old" value="{{ $brand->image_url }}">
                                            <input value="" class="span3" id="hinhanh" name="image" type="file" />
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
